...
- **Skills**: type **`/`** in the input to open the skill palette — pick an installed [Agent Skill](/guides/skills) and it becomes a chip on your message; the agent reads that skill first and follows its instructions for the task.
...
- [Agent Skills](/guides/skills) — instruction packs the bot (and external agents) can invoke
