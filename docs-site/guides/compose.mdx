...
- **Sequence** (Video) — a lightweight track-style clip assembler; see [video-and-audio.md](/guides/video-and-audio).
- **Director Timeline + Timeline Render** — a full clip timeline with a one-click render is on the [roadmap](/guides/roadmap).
