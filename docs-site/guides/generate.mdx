...
- **🔗 Link workflow** — *the recommended way to use your own workflow.* Pick one straight from ComfyUI's own workflow library; edit it in ComfyUI and save, and ComfyTV picks up changes automatically. See [custom-workflows.md](/guides/custom-workflows).
...
Once you have a clip, the whole [video suite](/guides/video-and-audio) — editing, color, keying, compositing, FX — takes over from there.
...
Output is a single FLAC audio file. From there the [audio suite](/guides/video-and-audio) (EQ, stem split, reverb, …) and the [Music nodes](/guides/making-music) can pick it up.
