---
title: "Making Music in ComfyTV/ComfyUI"
description: "From a score (or a prompt asking an LLM to write one) to a finished, reverb-polished audio track — all on one canvas, no external software. This page walks through the four stages — **composition → performance → synthesis → mixing** — explaining the musical concepts and every parameter on the way."
---
