...
Moving 360° footage has its own nodes in **ComfyTV / VideoFX**: **360 Projection** (re-project equirectangular ↔ flat views) and **360 Stabilize** (horizon-locked stabilization for 360 clips). See [video-and-audio.md](/guides/video-and-audio).
