---
title: "Load Audio from Asset"
description: "Pick audio from the ComfyTV **project asset library**—reuse Speech/Music Stage output or imports for Video Stage, timelines, or reference audio."
sidebarTitle: "Load Audio from Asset"
---

<Frame caption="Load Audio from Asset · screenshot coming soon">
  <img src="/images/nodes/_placeholder.svg" alt="Load Audio from Asset" />
</Frame>
