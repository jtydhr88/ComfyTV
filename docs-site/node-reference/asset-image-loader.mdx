---
title: "Load Image from Asset"
description: "Pick an image from the ComfyTV **project asset library** as pipeline input—ideal for reusing generated, edited, or imported results in the current project, not raw `input/` files."
sidebarTitle: "Load Image from Asset"
---

<Frame caption="Load Image from Asset · screenshot coming soon">
  <img src="/images/nodes/_placeholder.svg" alt="Load Image from Asset" />
</Frame>
