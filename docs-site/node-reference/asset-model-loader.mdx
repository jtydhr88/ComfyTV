...
description: "Pick a 3D model from your project's asset library and bring it into the pipeline—no upload, no generation."
sidebarTitle: "Load 3D Model from Asset"
---

<Frame caption="Load 3D Model from Asset · screenshot coming soon">
