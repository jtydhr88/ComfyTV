---
title: "Load Video from Asset"
description: "Pick a video from the ComfyTV **project asset library** for clip, demux, upscale, or other downstream steps—reuse in-project media, not raw `input/` files."
sidebarTitle: "Load Video from Asset"
---

<Frame caption="Load Video from Asset · screenshot coming soon">
  <img src="/images/nodes/_placeholder.svg" alt="Load Video from Asset" />
</Frame>
