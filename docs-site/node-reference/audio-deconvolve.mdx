---
title: "Audio Deconvolve (IR)"
description: "Recover an impulse response from a recorded sine-sweep — turn a room, cabinet, or device into a reusable IR."
sidebarTitle: "Audio Deconvolve"
---

<Frame caption="Audio Deconvolve (IR) · screenshot coming soon">
  <img src="/images/nodes/_placeholder.svg" alt="Audio Deconvolve (IR)" />
</Frame>
