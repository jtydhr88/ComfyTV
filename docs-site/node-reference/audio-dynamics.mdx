---
title: "Audio Dynamics"
description: "Tame or shape the level of a track with a compressor, gate, limiter, or de-esser — the same dynamics tools you'd reach for in a DAW."
sidebarTitle: "Audio Dynamics"
---

<Frame caption="Audio Dynamics · screenshot coming soon">
  <img src="/images/nodes/_placeholder.svg" alt="Audio Dynamics" />
</Frame>
