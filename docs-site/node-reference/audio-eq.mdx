---
title: "Audio EQ"
description: "A parametric equalizer driven by a graphical EQ curve — boost, cut, and filter frequency bands to shape the tone of a track."
sidebarTitle: "Audio EQ"
---

<Frame caption="Audio EQ · screenshot coming soon">
  <img src="/images/nodes/_placeholder.svg" alt="Audio EQ" />
</Frame>
