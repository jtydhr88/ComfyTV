---
title: "Audio · Background Only"
description: "**Roadmap / pending** — Demucs accompaniment / instrumental stem. Pairs with **Vocals Only**; `audio-bg/` reserved."
sidebarTitle: "Audio · Background Only"
---

<Frame caption="Audio · Background Only · screenshot coming soon">
  <img src="/images/nodes/_placeholder.svg" alt="Audio · Background Only" />
</Frame>
