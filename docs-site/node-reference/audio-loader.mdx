---
title: "Load Audio"
description: "Pick or upload local audio from ComfyUI's `input/` folder as the **starting point** for ComfyTV audio pipelines—voiceover, mixing, and IA2V video inputs."
sidebarTitle: "Load Audio"
---

<Frame caption="Load Audio · screenshot coming soon">
  <img src="/images/nodes/_placeholder.svg" alt="Load Audio" />
</Frame>
