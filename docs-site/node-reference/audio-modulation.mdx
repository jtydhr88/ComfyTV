...
description: "Classic time-modulation effects — phaser, flanger, chorus, vibrato, tremolo, and pulsator — in one node."
sidebarTitle: "Audio Modulation"
---

<Frame caption="Audio Modulation · screenshot coming soon">
  <img src="/images/nodes/_placeholder.svg" alt="Audio Modulation" />
</Frame>
