---
title: "Audio Sweep (ESS)"
description: "Generate an exponential sine-sweep test signal — the excitation used to capture a room or device's impulse response."
sidebarTitle: "Audio Sweep"
---

<Frame caption="Audio Sweep (ESS) · screenshot coming soon">
  <img src="/images/nodes/_placeholder.svg" alt="Audio Sweep (ESS)" />
</Frame>
