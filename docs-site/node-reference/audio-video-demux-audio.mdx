---
title: "Demux · Audio Track"
description: "**Extract the audio stream** from a video container as `COMFYTV_AUDIO`. **PyAV** — pairs with **Demux · Silent Video**."
sidebarTitle: "Demux · Audio Track"
---

<Frame caption="Demux · Audio Track · screenshot coming soon">
  <img src="/images/nodes/_placeholder.svg" alt="Demux · Audio Track" />
</Frame>
