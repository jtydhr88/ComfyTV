---
title: "Demux · Silent Video"
description: "Strip the audio track, keep video → silent `COMFYTV_VIDEO`. **PyAV** — pairs with **Demux · Audio Track**."
sidebarTitle: "Demux · Silent Video"
---

<Frame caption="Demux · Silent Video · screenshot coming soon">
  <img src="/images/nodes/_placeholder.svg" alt="Demux · Silent Video" />
</Frame>
