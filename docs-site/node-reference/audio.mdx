---
title: "Music Stage (Audio Stage)"
description: "Generates music or songs from style tags and optional lyrics—instrumental or vocal—not the same as Speech Stage text-to-speech."
sidebarTitle: "Music Stage"
---

<Frame caption="Music Stage (Audio Stage) · screenshot coming soon">
  <img src="/images/nodes/_placeholder.svg" alt="Music Stage (Audio Stage)" />
</Frame>
