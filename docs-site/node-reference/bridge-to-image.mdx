---
title: "→ ComfyTV Image"
description: "**Into-bridge**: convert native ComfyUI **IMAGE** tensor (any plugin) to a **COMFYTV_IMAGE** URL snapshot. Click **▶ Run** to write `output/ComfyTV/bridge/` and persist in the project."
sidebarTitle: "→ ComfyTV Image"
---
