---
title: "→ ComfyTV Images"
description: "**Into-bridge**: save each frame of a ComfyUI **IMAGE batch** as PNG → **COMFYTV_IMAGES** JSON + selected **COMFYTV_IMAGE**. Requires **▶ Run**."
sidebarTitle: "→ ComfyTV Images"
---
