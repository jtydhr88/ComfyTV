---
title: "→ ComfyTV Text"
description: "**Into-bridge**: any ComfyUI **STRING** (prompt enhance, caption, LLM) → **COMFYTV_TEXT** snapshot. **▶ Run** persists in project lineage (text stored as string, not PNG)."
sidebarTitle: "→ ComfyTV Text"
---
