...
description: "Split the red/green/blue channels outward from a center point for that \"cheap lens\" color fringing look — or dial it negative to pull fringing in."
sidebarTitle: "Chromatic Aberration"
---

<Frame caption="Chromatic Aberration · screenshot coming soon">
  <img src="/images/nodes/_placeholder.svg" alt="Chromatic Aberration" />
</Frame>
