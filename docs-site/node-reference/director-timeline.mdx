...
description: "Arrange image clips and optional audio on a visual timeline, outputting structured `COMFYTV_TIMELINE`—the \"edit decision list\" for multi-shot short video."
sidebarTitle: "Director Timeline"
---

<Frame caption="Director Timeline · screenshot coming soon">
  <img src="/images/nodes/_placeholder.svg" alt="Director Timeline" />
</Frame>
