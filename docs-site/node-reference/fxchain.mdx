---
title: "FX Chain"
description: "Bake a whole chain of upstream FX stages into the video in a single transcode pass, and set the delivery format."
sidebarTitle: "FX Chain"
---

<Frame caption="FX Chain · screenshot coming soon">
  <img src="/images/nodes/_placeholder.svg" alt="FX Chain" />
</Frame>
