...
description: "One-click neutral color — removes a color cast automatically using the gray-world assumption."
sidebarTitle: "Auto White Balance"
---

<Frame caption="Auto White Balance · screenshot coming soon">
