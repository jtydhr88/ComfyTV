---
title: "Image Stage"
description: "Generates one or more images from text with local or built-in models—the main “create from scratch” entry in ComfyTV, with img2img (i2i) support."
sidebarTitle: "Image Stage"
---

<Frame caption="Image Stage · screenshot coming soon">
  <img src="/images/nodes/_placeholder.svg" alt="Image Stage" />
</Frame>
