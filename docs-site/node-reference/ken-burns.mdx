---
title: "Ken Burns"
description: "Turns a single still image into a video with a slow pan-and-zoom move, in one ▶ Run."
sidebarTitle: "Ken Burns"
---

<Frame caption="Ken Burns · screenshot coming soon">
  <img src="/images/nodes/_placeholder.svg" alt="Ken Burns" />
</Frame>
