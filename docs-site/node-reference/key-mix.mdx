---
title: "Key Mix"
description: "Composite one clip over another through a matte — the \"put the keyed subject on the new background\" step."
sidebarTitle: "Key Mix"
---

<Frame caption="Key Mix · screenshot coming soon">
  <img src="/images/nodes/_placeholder.svg" alt="Key Mix" />
</Frame>
