---
title: "Lens Distort"
description: "Add or remove barrel/pincushion lens distortion using real camera-lens models — the same math VFX tools like Nuke and 3DEqualizer use."
sidebarTitle: "Lens Distort"
---

<Frame caption="Lens Distort · screenshot coming soon">
  <img src="/images/nodes/_placeholder.svg" alt="Lens Distort" />
</Frame>
