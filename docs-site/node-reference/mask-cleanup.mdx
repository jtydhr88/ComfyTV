---
title: "Mask Cleanup (ComfyTV)"
description: "Removes stray specks and fills pinholes in a mask so downstream cutouts, keys, and inpaints have clean, solid edges."
sidebarTitle: "Mask Cleanup"
---

<Frame caption="Mask Cleanup (ComfyTV) · screenshot coming soon">
  <img src="/images/nodes/_placeholder.svg" alt="Mask Cleanup (ComfyTV)" />
</Frame>
