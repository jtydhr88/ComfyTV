---
title: "Mesh Ops"
description: "One node, many mesh operations — decimate, remesh, weld, fill holes, smooth normals, subdivide, UV-unwrap, or export — chosen from a dropdown, with its own parameters shown on the card."
sidebarTitle: "Mesh Ops"
---

<Frame caption="Mesh Ops · screenshot coming soon">
  <img src="/images/nodes/_placeholder.svg" alt="Mesh Ops" />
</Frame>
