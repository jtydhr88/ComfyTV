---
title: "Panorama · Current View"
description: "Aim anywhere inside the 360° panorama viewer and capture the current viewport as a flat image (`COMFYTV_IMAGE`)."
sidebarTitle: "Panorama · Current View"
---

<Frame caption="Panorama · Current View · screenshot coming soon">
  <img src="/images/nodes/_placeholder.svg" alt="Panorama · Current View" />
</Frame>
