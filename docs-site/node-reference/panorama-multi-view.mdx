---
title: "Panorama · Multi-View"
description: "Capture multiple evenly spaced viewport shots from one 360° panorama in a single Run — outputs a `COMFYTV_IMAGES` batch for storyboards and multi-camera setups."
sidebarTitle: "Panorama · Multi-View"
---

<Frame caption="Panorama · Multi-View · screenshot coming soon">
  <img src="/images/nodes/_placeholder.svg" alt="Panorama · Multi-View" />
</Frame>
