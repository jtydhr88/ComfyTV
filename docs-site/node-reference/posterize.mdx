---
title: "Posterize"
description: "Reduce the clip to a small palette of flat colors — a poster / screen-print / cel-shaded look via color quantization."
sidebarTitle: "Posterize"
---

<Frame caption="Posterize · screenshot coming soon">
