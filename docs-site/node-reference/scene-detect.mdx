---
title: "Scene Detect"
description: "Find the cuts in a video and split it into per-shot thumbnails or ready-to-use clips."
sidebarTitle: "Scene Detect"
---

<Frame caption="Scene Detect · screenshot coming soon">
  <img src="/images/nodes/_placeholder.svg" alt="Scene Detect" />
</Frame>
