---
title: "Score Editor"
description: "A beat-domain piano-roll editor. Draw, step-enter and edit notes across up to four parts, then export a MusicXML score."
sidebarTitle: "Score Editor"
---

<Frame caption="Score Editor in ComfyTV">
