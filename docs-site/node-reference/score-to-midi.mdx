...
description: "Turn a written score into an expressive performance — swing, human feel, per-instrument phrasing — and get a MIDI file out."
sidebarTitle: "Score Performer"
---

<Frame caption="Score Performer · screenshot coming soon">
