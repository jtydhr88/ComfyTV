---
title: "Speech Stage"
description: "Synthesizes spoken narration and dialogue (TTS) from a script—not the same as Music Stage song/instrumental generation."
sidebarTitle: "Speech Stage"
---

<Frame caption="Speech Stage · screenshot coming soon">
  <img src="/images/nodes/_placeholder.svg" alt="Speech Stage" />
</Frame>
