...
description: "Uses an LLM to expand a short story premise into a structured shot list (16 fields per shot) for Shot Images—this node does not generate pictures itself."
sidebarTitle: "Storyboard Stage"
---

<Frame caption="Storyboard Stage · screenshot coming soon">
  <img src="/images/nodes/_placeholder.svg" alt="Storyboard Stage" />
</Frame>
