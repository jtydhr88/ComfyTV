---
title: "Time Remap"
description: "Variable-speed retiming and freeze-frames — ramp a clip from slow-mo to fast, or hold on a single frame."
sidebarTitle: "Time Remap"
---

<Frame caption="Time Remap · screenshot coming soon">
  <img src="/images/nodes/_placeholder.svg" alt="Time Remap" />
</Frame>
