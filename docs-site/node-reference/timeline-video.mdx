...
description: "Encode a **Director Timeline** sequence into a finished video—the **export** step of a multi-shot timeline workflow."
sidebarTitle: "Timeline Render"
---

<Frame caption="Timeline Render · screenshot coming soon">
  <img src="/images/nodes/_placeholder.svg" alt="Timeline Render" />
</Frame>
