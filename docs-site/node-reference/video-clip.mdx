---
title: "Video Clip"
description: "Trim a video to a [start_s, end_s] range, keep original frame rate. **PyAV** on disk → new `COMFYTV_VIDEO` snapshot."
sidebarTitle: "Video Clip"
---

<Frame caption="Video Clip · screenshot coming soon">
  <img src="/images/nodes/_placeholder.svg" alt="Video Clip" />
</Frame>
