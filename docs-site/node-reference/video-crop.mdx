---
title: "Video Crop"
description: "Crop the same rectangle on every frame. **PyAV** processing, frame rate unchanged → `COMFYTV_VIDEO`. This is a **PyAV media-processing** stage—not AI video generation via **Video Stage**."
sidebarTitle: "Video Crop"
---

<Frame caption="Video Crop · screenshot coming soon">
  <img src="/images/nodes/_placeholder.svg" alt="Video Crop" />
</Frame>
