---
title: "Extract Frame"
description: "Grab one still from a video (first, last, middle, or a custom timestamp) as `COMFYTV_IMAGE`. Uses **PyAV** on disk — no GPU."
sidebarTitle: "Extract Frame"
---

<Frame caption="Extract Frame · screenshot coming soon">
  <img src="/images/nodes/_placeholder.svg" alt="Extract Frame" />
</Frame>
