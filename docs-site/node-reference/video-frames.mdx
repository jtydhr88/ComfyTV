...
description: "Grab still frames from a clip at timestamps you mark, and get them back as an image batch."
sidebarTitle: "Extract Frames"
---

<Frame caption="Extract Frames · screenshot coming soon">
  <img src="/images/nodes/_placeholder.svg" alt="Extract Frames" />
</Frame>
