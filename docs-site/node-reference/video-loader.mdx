---
title: "Load Video"
description: "Pick or upload a local video from ComfyUI's `input/` folder as the **starting point** for ComfyTV video pipelines—clip, extract frames, demux, and more."
sidebarTitle: "Load Video"
---

<Frame caption="Load Video · screenshot coming soon">
  <img src="/images/nodes/_placeholder.svg" alt="Load Video" />
</Frame>
