---
title: "Video Resize"
description: "Change output width/height (-1 keeps aspect). Frame rate unchanged. **PyAV** resample → `COMFYTV_VIDEO`. This is a **PyAV media-processing** stage—not AI video generation via **Video Stage**."
sidebarTitle: "Video Resize"
---

<Frame caption="Video Resize · screenshot coming soon">
  <img src="/images/nodes/_placeholder.svg" alt="Video Resize" />
</Frame>
