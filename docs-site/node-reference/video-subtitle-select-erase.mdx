---
title: "Subtitle Erase · Region"
description: "**Roadmap / pending** — erase subtitles inside a user-drawn rectangle per frame. Box UI incomplete; Run raises `StageNotImplemented`."
sidebarTitle: "Subtitle Erase · Region"
---

<Frame caption="Subtitle Erase · Region · screenshot coming soon">
  <img src="/images/nodes/_placeholder.svg" alt="Subtitle Erase · Region" />
</Frame>
