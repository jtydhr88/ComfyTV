---
title: "Subtitle Erase · Smart"
description: "**Roadmap / pending** — auto-detect and remove burned-in subtitles. Run raises `StageNotImplemented`."
sidebarTitle: "Subtitle Erase · Smart"
---

<Frame caption="Subtitle Erase · Smart · screenshot coming soon">
  <img src="/images/nodes/_placeholder.svg" alt="Subtitle Erase · Smart" />
</Frame>
