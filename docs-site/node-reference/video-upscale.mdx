---
title: "Video Upscale"
description: "**Roadmap / pending** — intended AI per-frame video enlargement (2x / 4x). Run currently raises `StageNotImplemented`; no real backend yet."
sidebarTitle: "Video Upscale"
---

<Frame caption="Video Upscale · screenshot coming soon">
  <img src="/images/nodes/_placeholder.svg" alt="Video Upscale" />
</Frame>
