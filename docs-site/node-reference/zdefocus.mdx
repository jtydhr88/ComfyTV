---
title: "Z Defocus"
description: "Depth-based defocus — blur your footage by distance using a depth map, so foreground or background goes soft with real bokeh discs."
sidebarTitle: "Z Defocus"
---

<Frame caption="Z Defocus · screenshot coming soon">
  <img src="/images/nodes/_placeholder.svg" alt="Z Defocus" />
</Frame>
