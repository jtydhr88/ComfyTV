...
translationSourceHash: "91c44368bcd5738e"
---
...
- **技能**:输入框打 **`/`** 唤出技能面板 — 选一个已安装的 [Agent Skill](/guides/skills),它会变成消息上的一枚 chip;agent 先读该技能,再按其指令执行任务。
...
- [Agent Skills](/guides/skills) — Bot(和外部 agent)可调用的指令包
