---
title: "拼接 & 编排"
translationSourceHash: "0352a46bc0f12439"
---

## Image Picker(图片选择器)

![Image picker](/images/picker-toolbar.png)从一组图(来自 Image Stage、Grid Split、Image Variations、Panorama Multi-View……)里选**一张**。
