---
title: "拼接 & 编排"
translationSourceHash: "7061b7d50f1ee5ee"
---
...
- **Sequence**（Video）—— 轻量的轨道式拼装器，见 [video-and-audio.zh.md](/zh/guides/video-and-audio)。
- **Director Timeline + Timeline Render** —— 完整的素材时间线 + 一键渲染在 [roadmap](/zh/guides/roadmap) 上。
