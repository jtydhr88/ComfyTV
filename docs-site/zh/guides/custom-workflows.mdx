---
title: "自定义工作流"
translationSourceHash: "1492c6cd25bd1bdf"
---
...
**通过侧边栏改**:画布上点中 stage,左侧 **ComfyTV** 侧边栏里逐个 widget 设。改完即生效,不必重启。详细操作见 [sidebar-config-editor.zh.md](/zh/guides/sidebar-config-editor)。
