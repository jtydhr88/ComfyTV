---
title: "入门"
translationSourceHash: "6ef5dc3541cc8b04"
---
...
- [generate.zh.md](/zh/guides/generate),生成器(文/图/视频/音频)
- [image-tools.zh.md](/zh/guides/image-tools),裁剪、旋转、Inpaint 以及其它编辑工具
- [compose.zh.md](/zh/guides/compose),Picker、A/B 对比
