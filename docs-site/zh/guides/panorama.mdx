...
动态的 360° 素材在 **ComfyTV / VideoFX** 里有专门节点:**360 Projection**(equirectangular ↔ 平面视图重投影)和 **360 Stabilize**(360 片段的水平线锁定防抖)。见 [video-and-audio.zh.md](/zh/guides/video-and-audio)。
