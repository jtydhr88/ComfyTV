...
translationSourceHash: "915b02563c21ba20"
---
...
后端还没接上的：**Video Upscale**、**Subtitle Erase（Smart / Region）**——见 [roadmap.zh.md](/zh/guides/roadmap)。
...
**音乐创作**（乐谱、钢琴卷帘、SoundFont 合成）见 [making-music.zh.md](/zh/guides/making-music)。
