---
title: "从资产库加载图片"
description: "从 ComfyTV **项目资产库**里挑选一张图片作为流程输入——适合复用本项目中生成、编辑或导入的结果，而不是 `input/` 里的原始文件。"
sidebarTitle: "从资产库加载图片"
translationSourceHash: "a69f9069c5c750af"
---

<Frame caption="从资产库加载图片 · 截图待补">
  <img src="/images/nodes/_placeholder.svg" alt="从资产库加载图片" />
</Frame>
