---
title: "Audio Denoise（音频降噪）"
description: "去除音轨里的稳态背景噪声——风扇哼声、磁带嘶声、空调低鸣——或裁掉静音间隙。"
sidebarTitle: "Audio Denoise（音频降噪）"
translationSourceHash: "1da25a281752e999"
---

<Frame caption="Audio Denoise（音频降噪） · 截图待补">
  <img src="/images/nodes/_placeholder.svg" alt="Audio Denoise（音频降噪）" />
</Frame>
