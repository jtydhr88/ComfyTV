---
title: "Audio EQ（音频均衡）"
description: "由图形化 EQ 曲线驱动的参量均衡器——通过增益、衰减和滤波各频段来塑造音轨的音色。"
sidebarTitle: "Audio EQ（音频均衡）"
translationSourceHash: "6d2fcface260057a"
---

<Frame caption="Audio EQ（音频均衡） · 截图待补">
  <img src="/images/nodes/_placeholder.svg" alt="Audio EQ（音频均衡）" />
</Frame>
