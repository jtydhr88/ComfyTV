---
title: "仅伴奏 (Audio · Background Only)"
description: "**路线图 / 待支持** —— 设计为用 Demucs 分离 **伴奏 / 环境音**；与 **Vocals Only** 配对，workflow 目录 `audio-bg/` 预留。"
sidebarTitle: "仅伴奏"
translationSourceHash: "c31df7e700f13800"
---

<Frame caption="仅伴奏 (Audio · Background Only) · 截图待补">
  <img src="/images/nodes/_placeholder.svg" alt="仅伴奏 (Audio · Background Only)" />
</Frame>
