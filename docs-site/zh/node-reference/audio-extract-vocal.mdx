---
title: "仅人声 (Audio · Vocals Only)"
description: "**路线图 / 待支持** —— 设计为用 Demucs 从视频/混音里分离 **人声**；workflow 槽位已有，后端待接入。"
sidebarTitle: "仅人声"
translationSourceHash: "c1784d5a5845f6e7"
---

<Frame caption="仅人声 (Audio · Vocals Only) · 截图待补">
  <img src="/images/nodes/_placeholder.svg" alt="仅人声 (Audio · Vocals Only)" />
</Frame>
