---
title: "加载音频"
description: "从 ComfyUI 的 `input/` 文件夹选取或上传本地音频，作为 ComfyTV 音频流程的**起点**——配音、混音、接视频 IA2V 等都从这里接。"
sidebarTitle: "加载音频"
translationSourceHash: "6d5a37de7795f38b"
---

<Frame caption="加载音频 · 截图待补">
  <img src="/images/nodes/_placeholder.svg" alt="加载音频" />
</Frame>
