---
title: "Audio Loudness（音频响度）"
description: "把音轨调到一致、符合播出规范的响度——EBU R128 归一、自适应平衡，或简单的峰值/RMS/LUFS 匹配。"
sidebarTitle: "Audio Loudness（音频响度）"
translationSourceHash: "bba7d1e99d0df28a"
---

<Frame caption="Audio Loudness（音频响度） · 截图待补">
  <img src="/images/nodes/_placeholder.svg" alt="Audio Loudness（音频响度）" />
</Frame>
