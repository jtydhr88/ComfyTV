---
title: "Audio Time / Pitch（音频变速/变调）"
description: "改变速度、移调，或时间拉伸音轨——并提供高质量相位声码器选项，让音高与速度相互独立。"
sidebarTitle: "Audio Time / Pitch（音频变速/变调）"
translationSourceHash: "f4690395ed08e0f1"
---

<Frame caption="Audio Time / Pitch（音频变速/变调） · 截图待补">
  <img src="/images/nodes/_placeholder.svg" alt="Audio Time / Pitch（音频变速/变调）" />
</Frame>
