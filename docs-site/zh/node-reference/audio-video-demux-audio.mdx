---
title: "分离音轨 (Demux · Audio Track)"
description: "从视频容器里 **提取音轨** 为独立 `COMFYTV_AUDIO`，**PyAV** 处理；与 **Demux · Silent Video** 配对使用。"
sidebarTitle: "分离音轨"
translationSourceHash: "9da09717c75d3e21"
---

<Frame caption="分离音轨 (Demux · Audio Track) · 截图待补">
  <img src="/images/nodes/_placeholder.svg" alt="分离音轨 (Demux · Audio Track)" />
</Frame>
