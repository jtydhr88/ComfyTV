---
title: "音乐阶段 (Music Stage)"
description: "根据风格标签和可选歌词生成音乐或歌曲（器乐 / 人声），与 Speech Stage 的「念台词」完全不同。"
sidebarTitle: "音乐阶段"
translationSourceHash: "d8c976a4d0d30774"
---

<Frame caption="音乐阶段 (Music Stage) · 截图待补">
  <img src="/images/nodes/_placeholder.svg" alt="音乐阶段 (Music Stage)" />
</Frame>
