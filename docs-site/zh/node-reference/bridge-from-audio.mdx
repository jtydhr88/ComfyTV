---
title: "← ComfyTV 音频 (Bridge From Audio)"
description: "**出桥**：**COMFYTV_AUDIO** wav URL → 原生 **AUDIO** dict；**无 ▶ 运行**，Queue 时用 torchaudio 加载。"
sidebarTitle: "← ComfyTV 音频"
translationSourceHash: "0b05068f872f7c04"
---
