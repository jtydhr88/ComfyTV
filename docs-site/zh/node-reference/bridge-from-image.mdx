---
title: "← ComfyTV 图像 (Bridge From Image)"
description: "**出桥**：**COMFYTV_IMAGE** URL 快照 → 原生 **IMAGE** 内存图像；**无 ▶ 运行**，随 ComfyUI 图执行时从磁盘加载 PNG。"
sidebarTitle: "← ComfyTV 图像"
translationSourceHash: "ea60f015a597a296"
---
