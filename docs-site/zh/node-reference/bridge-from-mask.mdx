---
title: "← ComfyTV 蒙版 (Bridge From Mask)"
description: "**出桥**：从 **COMFYTV_IMAGE**（常带 alpha 的 PNG）提取 **MASK** 内存蒙版；**无 ▶ 运行**，Queue 时加载。"
sidebarTitle: "← ComfyTV 蒙版"
translationSourceHash: "8df02ed4230fc12d"
---
