---
title: "→ ComfyTV 音频 (Bridge To Audio)"
description: "**入桥**：ComfyUI **AUDIO** dict → **COMFYTV_AUDIO** wav URL；**▶ 运行** 写入 `output/ComfyTV/bridge/*.wav`。"
sidebarTitle: "→ ComfyTV 音频"
translationSourceHash: "08f5a4da605de6ed"
---
