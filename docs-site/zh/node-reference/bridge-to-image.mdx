---
title: "→ ComfyTV 图像 (Bridge To Image)"
description: "**入桥**：把 ComfyUI 原生 **IMAGE** 内存图像（任意插件输出）转成 ComfyTV 的 **COMFYTV_IMAGE** URL 快照；须点 **▶ 运行** 写入 `output/ComfyTV/bridge/` 并持久化到项目。"
sidebarTitle: "→ ComfyTV 图像"
translationSourceHash: "30c0b17c3dbea809"
---
