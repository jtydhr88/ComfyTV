---
title: "→ ComfyTV 多图 (Bridge To Images)"
description: "**入桥**：把 ComfyUI **IMAGE 批量**（B>1）逐帧存 PNG，输出 **COMFYTV_IMAGES** JSON + 当前选中 **COMFYTV_IMAGE**；须 **▶ 运行**。"
sidebarTitle: "→ ComfyTV 多图"
translationSourceHash: "f105e11a1db676a0"
---
