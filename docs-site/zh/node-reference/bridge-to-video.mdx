---
title: "→ ComfyTV 视频 (Bridge To Video)"
description: "**入桥**：ComfyUI **VIDEO** 对象（如 **mesh2motion**）→ **COMFYTV_VIDEO** URL；**▶ 运行** 写入 `output/ComfyTV/bridge/*.mp4`。"
sidebarTitle: "→ ComfyTV 视频"
translationSourceHash: "cdaf71081ccb585e"
---
