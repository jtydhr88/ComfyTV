---
title: "审片宫格 (Contact Sheet)"
description: "把视频中均匀采样的帧排成一张网格图——用来一眼扫完整段片子的审片宫格 / contact sheet。"
sidebarTitle: "审片宫格"
translationSourceHash: "8da401f0bd98c2d2"
---

<Frame caption="审片宫格 (Contact Sheet) · 截图待补">
  <img src="/images/nodes/_placeholder.svg" alt="审片宫格 (Contact Sheet)" />
</Frame>
