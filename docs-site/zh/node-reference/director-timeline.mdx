---
title: "导演时间线"
description: "在可视化时间线上排列图片片段与可选音轨，输出结构化 `COMFYTV_TIMELINE`——多镜短视频的「剪辑表」编辑器。"
sidebarTitle: "导演时间线"
translationSourceHash: "2ea5e8f8defcd334"
---

<Frame caption="导演时间线 · 截图待补">
  <img src="/images/nodes/_placeholder.svg" alt="导演时间线" />
</Frame>
