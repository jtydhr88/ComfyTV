---
title: "图像阶段 (Image Stage)"
description: "用本地或内置模型根据文字描述生成一张或多张图片，是 ComfyTV 里最常用的「从零创作」入口，也支持图生图 (i2i)。"
sidebarTitle: "图像阶段"
translationSourceHash: "e7c095ecdf02979b"
---

<Frame caption="图像阶段 (Image Stage) · 截图待补">
  <img src="/images/nodes/_placeholder.svg" alt="图像阶段 (Image Stage)" />
</Frame>
