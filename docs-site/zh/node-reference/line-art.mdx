---
title: "线稿 (Line Art)"
description: "把 3D 模型渲染成干净的线稿——轮廓、折痕与开放边界，带隐线消除——可直接作为 ControlNet lineart 图使用。"
sidebarTitle: "线稿"
translationSourceHash: "39830d37a09b68ce"
---

<Frame caption="线稿 (Line Art) · 截图待补">
  <img src="/images/nodes/_placeholder.svg" alt="线稿 (Line Art)" />
</Frame>
