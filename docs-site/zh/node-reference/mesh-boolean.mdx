---
title: "网格布尔 (Mesh Boolean)"
description: "用 CSG 合并两个网格——union 合并、difference 从一个里挖出另一个、intersect 只保留重叠——通过卡片上的 gizmo 摆放。"
sidebarTitle: "网格布尔"
translationSourceHash: "b86da6eb2623f85b"
---

<Frame caption="网格布尔 (Mesh Boolean) · 截图待补">
  <img src="/images/nodes/_placeholder.svg" alt="网格布尔 (Mesh Boolean)" />
</Frame>
