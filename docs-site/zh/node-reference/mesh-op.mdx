---
title: "网格操作 (Mesh Ops)"
description: "一个节点，多种网格操作——decimate、remesh、weld、fill holes、smooth normals、subdivide、UV 展开或 export——从下拉框选择，卡片只显示对应操作的参数。"
sidebarTitle: "网格操作"
translationSourceHash: "f954b419d602b365"
---

<Frame caption="网格操作 (Mesh Ops) · 截图待补">
  <img src="/images/nodes/_placeholder.svg" alt="网格操作 (Mesh Ops)" />
</Frame>
