---
title: "网格基元 (Mesh Primitive)"
description: "生成一个干净的基础网格——立方体、球体、圆柱、圆锥、平面或圆环——用来开始一次 3D 建模，或喂给几何工坊的其余节点。"
sidebarTitle: "网格基元"
translationSourceHash: "40845a3e83e3fa8d"
---

<Frame caption="网格基元 (Mesh Primitive) · 截图待补">
  <img src="/images/nodes/_placeholder.svg" alt="网格基元 (Mesh Primitive)" />
</Frame>
