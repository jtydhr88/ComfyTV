---
title: "全景图 · 当前视角 (Panorama · Current View)"
description: "在 360° 全景查看器里瞄准任意方向，截取当前视口为一张普通平面图（`COMFYTV_IMAGE`）。"
sidebarTitle: "全景图 · 当前视角"
translationSourceHash: "6159dbebab391b10"
---

<Frame caption="全景图 · 当前视角 (Panorama · Current View) · 截图待补">
  <img src="/images/nodes/_placeholder.svg" alt="全景图 · 当前视角 (Panorama · Current View)" />
</Frame>
