---
title: "全景图 · 多视角 (Panorama · Multi-View)"
description: "从一张 360° 全景一次性截取多张等间距视口图，输出 `COMFYTV_IMAGES` 批量，适合分镜和多机位。"
sidebarTitle: "全景图 · 多视角"
translationSourceHash: "dda8e7845acc7016"
---

<Frame caption="全景图 · 多视角 (Panorama · Multi-View) · 截图待补">
  <img src="/images/nodes/_placeholder.svg" alt="全景图 · 多视角 (Panorama · Multi-View)" />
</Frame>
