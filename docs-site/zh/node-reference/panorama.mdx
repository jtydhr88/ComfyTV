---
title: "全景图 (Panorama)"
description: "交互式 360° 全景查看器：可上传 HDRI / equirectangular 图，或用 AI workflow 生成整张环绕全景，再从球心向四周浏览。"
sidebarTitle: "全景图"
translationSourceHash: "8c221ae891498839"
---

<Frame caption="全景图 (Panorama) · 截图待补">
  <img src="/images/nodes/_placeholder.svg" alt="全景图 (Panorama)" />
</Frame>
