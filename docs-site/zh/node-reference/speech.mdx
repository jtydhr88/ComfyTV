---
title: "语音阶段 (Speech Stage)"
description: "把台词脚本合成为可朗读的配音（TTS），用于旁白和对白；与 Music Stage 的歌曲/器乐生成完全不同。"
sidebarTitle: "语音阶段"
translationSourceHash: "ba556816aa6a0368"
---

<Frame caption="语音阶段 (Speech Stage) · 截图待补">
  <img src="/images/nodes/_placeholder.svg" alt="语音阶段 (Speech Stage)" />
</Frame>
