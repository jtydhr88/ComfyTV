---
title: "故事板 (Storyboard Stage)"
description: "用 LLM 把简短故事大纲扩写为结构化分镜表（每镜 16 个字段），供 Shot Images 逐镜出图——本节点本身不生成图片。"
sidebarTitle: "故事板"
translationSourceHash: "618295cae3562ed1"
---

<Frame caption="故事板 (Storyboard Stage) · 截图待补">
  <img src="/images/nodes/_placeholder.svg" alt="故事板 (Storyboard Stage)" />
</Frame>
