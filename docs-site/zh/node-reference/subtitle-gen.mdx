---
title: "语音转字幕 (Subtitles · Speech-to-Text)"
description: "自动把视频或音频里的语音转写成字幕文本，可直接喂给 Subtitles 节点。"
sidebarTitle: "语音转字幕"
translationSourceHash: "b69cba40eeffbde8"
---

<Frame caption="语音转字幕 (Subtitles · Speech-to-Text) · 截图待补">
  <img src="/images/nodes/_placeholder.svg" alt="语音转字幕 (Subtitles · Speech-to-Text)" />
</Frame>
