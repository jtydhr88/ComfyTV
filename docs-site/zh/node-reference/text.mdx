---
title: "文本阶段 (Text Stage)"
description: "用本地 LLM 根据你的指令生成一段文字，可扩写提示词、写场景描述，或为图像/视频 stage 提供上下文。"
sidebarTitle: "文本阶段"
translationSourceHash: "ff19b243c9eb58a3"
---

<Frame caption="文本阶段 (Text Stage) · 截图待补">
  <img src="/images/nodes/_placeholder.svg" alt="文本阶段 (Text Stage)" />
</Frame>
