---
title: "时间线渲染"
description: "把 **Director Timeline** 编排好的序列编码成成品视频——多镜时间线的「导出」步骤。"
sidebarTitle: "时间线渲染"
translationSourceHash: "7970cfd01e82c3a8"
---

<Frame caption="时间线渲染 · 截图待补">
  <img src="/images/nodes/_placeholder.svg" alt="时间线渲染" />
</Frame>
