---
title: "模糊 / 锐化 (Blur / Sharpen)"
description: "用多种模糊核或反锐化蒙版柔化或锐化整段素材，一次 ▶ 运行完成。"
sidebarTitle: "模糊 / 锐化"
translationSourceHash: "e5b1cebb0ebda5ff"
---

<Frame caption="模糊 / 锐化 (Blur / Sharpen) · 截图待补">
  <img src="/images/nodes/_placeholder.svg" alt="模糊 / 锐化 (Blur / Sharpen)" />
</Frame>
