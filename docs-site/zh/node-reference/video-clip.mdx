---
title: "视频剪辑 (Video Clip)"
description: "按起止时间剪出一段子片段，保留原帧率，**PyAV** 在磁盘处理，输出新的 `COMFYTV_VIDEO` 快照。"
sidebarTitle: "视频剪辑"
translationSourceHash: "29c58b1e6232322c"
---

<Frame caption="视频剪辑 (Video Clip) · 截图待补">
  <img src="/images/nodes/_placeholder.svg" alt="视频剪辑 (Video Clip)" />
</Frame>
