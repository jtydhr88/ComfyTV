---
title: "视频合成 (Video Composite)"
description: "用混合模式、不透明度、2D 变换、可选蒙版和可动画关键帧，把一个视频叠加到另一个视频之上。"
sidebarTitle: "视频合成"
translationSourceHash: "96c9821c852481b9"
---

<Frame caption="视频合成 (Video Composite) · 截图待补">
  <img src="/images/nodes/_placeholder.svg" alt="视频合成 (Video Composite)" />
</Frame>
