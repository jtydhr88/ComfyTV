---
title: "视频画面裁剪 (Video Crop)"
description: "对每一帧裁切同一矩形区域，**PyAV** 处理，帧率不变，输出 `COMFYTV_VIDEO`。这是 **PyAV 媒体处理** stage，不是 **Video Stage** 的 AI 视频生成。"
sidebarTitle: "视频画面裁剪"
translationSourceHash: "d237756befd0c2fa"
---

<Frame caption="视频画面裁剪 (Video Crop) · 截图待补">
  <img src="/images/nodes/_placeholder.svg" alt="视频画面裁剪 (Video Crop)" />
</Frame>
