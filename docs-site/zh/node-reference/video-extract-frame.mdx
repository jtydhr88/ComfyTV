---
title: "提取帧 (Extract Frame)"
description: "从视频里抽出一张静态图（首帧、末帧、中间帧或指定秒数），输出 `COMFYTV_IMAGE`，后端使用 **PyAV** 在磁盘原片上处理，不占 GPU。"
sidebarTitle: "提取帧"
translationSourceHash: "d10e34d47485766e"
---

<Frame caption="提取帧 (Extract Frame) · 截图待补">
  <img src="/images/nodes/_placeholder.svg" alt="提取帧 (Extract Frame)" />
</Frame>
