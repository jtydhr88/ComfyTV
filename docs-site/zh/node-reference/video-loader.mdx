---
title: "加载视频"
description: "从 ComfyUI 的 `input/` 文件夹选取或上传本地视频，作为 ComfyTV 视频流程的**起点**——剪辑、抽帧、Demux 等都从这里接。"
sidebarTitle: "加载视频"
translationSourceHash: "84931224df6b5128"
---

<Frame caption="加载视频 · 截图待补">
  <img src="/images/nodes/_placeholder.svg" alt="加载视频" />
</Frame>
