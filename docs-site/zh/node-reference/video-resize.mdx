---
title: "视频缩放 (Video Resize)"
description: "改变输出宽高（可设 -1 保持比例），帧率不变，**PyAV** 重采样，输出 `COMFYTV_VIDEO`。这是 **PyAV 媒体处理** stage，不是 **Video Stage** 的 AI 视频生成。"
sidebarTitle: "视频缩放"
translationSourceHash: "d659a16d6b3a8613"
---

<Frame caption="视频缩放 (Video Resize) · 截图待补">
  <img src="/images/nodes/_placeholder.svg" alt="视频缩放 (Video Resize)" />
</Frame>
