---
title: "字幕擦除 · 区域 (Subtitle Erase · Region)"
description: "**路线图 / 待支持** —— 在你框选的矩形区域内逐帧去字幕；需区域框选 UI，当前 Run 抛出 `StageNotImplemented`。"
sidebarTitle: "字幕擦除 · 区域"
translationSourceHash: "9b565dd2702fe35e"
---

<Frame caption="字幕擦除 · 区域 (Subtitle Erase · Region) · 截图待补">
  <img src="/images/nodes/_placeholder.svg" alt="字幕擦除 · 区域 (Subtitle Erase · Region)" />
</Frame>
