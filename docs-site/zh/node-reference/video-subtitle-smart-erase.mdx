---
title: "字幕擦除 · 智能 (Subtitle Erase · Smart)"
description: "**路线图 / 待支持** —— 设计为自动检测并去除内嵌硬字幕；当前 Run 抛出 `StageNotImplemented`。"
sidebarTitle: "字幕擦除 · 智能"
translationSourceHash: "11dc12edb8a2795b"
---

<Frame caption="字幕擦除 · 智能 (Subtitle Erase · Smart) · 截图待补">
  <img src="/images/nodes/_placeholder.svg" alt="字幕擦除 · 智能 (Subtitle Erase · Smart)" />
</Frame>
