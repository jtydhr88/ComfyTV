---
title: "视频高清 (Video Upscale)"
description: "**路线图 / 待支持** —— 设计意图是用 AI 逐帧放大视频（2x / 4x）；当前 Run 会抛出 `StageNotImplemented`，尚无真实 upscale 后端。"
sidebarTitle: "视频高清"
translationSourceHash: "95529dba14e9780f"
---

<Frame caption="视频高清 (Video Upscale) · 截图待补">
  <img src="/images/nodes/_placeholder.svg" alt="视频高清 (Video Upscale)" />
</Frame>
