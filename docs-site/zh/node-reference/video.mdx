---
title: "视频阶段 (Video Stage)"
description: "根据文字、图片、音视频条件生成短视频片段，内置 LTX 2.3 的四种模式（T2V / I2V / FLF2V / IA2V）。"
sidebarTitle: "视频阶段"
translationSourceHash: "dbe5ac393c9b5da4"
---

<Frame caption="视频阶段 (Video Stage) · 截图待补">
  <img src="/images/nodes/_placeholder.svg" alt="视频阶段 (Video Stage)" />
</Frame>
