(function() {
  ...
  try {
    if (typeof document != "undefined") {
      ...
      elementStyle.appendChild(document.createTextNode(`.ctv-asset-thumb[data-v-20b09ab0] {\r
  transition: transform 0.2s ease;
}
.ctv-asset-card:hover .ctv-asset-thumb[data-v-20b09ab0] {\r
  transform: scale(1.05);
}
.ctv-asset-actions[data-v-20b09ab0] {\r
  opacity: 0;\r
  pointer-events: none;\r
  transition: opacity 0.15s ease;
}
.ctv-asset-card:hover .ctv-asset-actions[data-v-20b09ab0],\r
.ctv-asset-card:focus-within .ctv-asset-actions[data-v-20b09ab0] {\r
  opacity: 1;\r
  pointer-events: auto;
}
...
.ctv-asset-actions[data-v-32037dd1] {\r
  opacity: 0;\r
  pointer-events: none;\r
  transition: opacity 0.15s ease;
}
.ctv-asset-row:hover .ctv-asset-actions[data-v-32037dd1],\r
.ctv-asset-row:focus-within .ctv-asset-actions[data-v-32037dd1] {\r
  opacity: 1;\r
  pointer-events: auto;
}
@media (hover: none), (pointer: coarse) {
...
@media (hover: hover) {
.ctv-bot-send[data-v-3bfa6b8c]:hover:not(:disabled) {
    filter: brightness(1.15);
}
.ctv-bot-attach[data-v-3bfa6b8c]:hover:not(:disabled) {
    background: color-mix(in srgb, currentColor 12%, transparent);
}
.ctv-bot-chip-x[data-v-3bfa6b8c]:hover {
    filter: brightness(1.4);
}
}
.ctv-bot-attach[data-v-3bfa6b8c] {
  display: flex;
  align-items: center;
  justify-content: center;
  width: 26px;
...
.ctv-bot-attach[data-v-3bfa6b8c]:disabled {
  opacity: 0.4;
  cursor: default;
}
.ctv-bot-attach-active[data-v-3bfa6b8c] {
  background: color-mix(in srgb, currentColor 14%, transparent);
  color: var(--input-text, #e0e0e0);
}
.ctv-bot-chip-x[data-v-3bfa6b8c] {
  position: absolute;
  top: -5px;
  right: -5px;
  display: flex;
...
.ctv-bot-iconbtn[data-v-84ce9796] {\r
  display: flex;\r
  align-items: center;\r
...
.ctv-bot-row-actions[data-v-84ce9796] {\r
  opacity: 0;
}
@media (hover: hover) {
.ctv-bot-iconbtn[data-v-84ce9796]:hover {\r
    background: color-mix(in srgb, currentColor 12%, transparent);
}
.ctv-bot-row[data-v-84ce9796]:hover {\r
    background: color-mix(in srgb, currentColor 4%, transparent);
}
.ctv-bot-row:hover .ctv-bot-row-actions[data-v-84ce9796] {\r
    opacity: 1;
}
}
@media (hover: none) {
...
.imgref-remove[data-v-452668e3] {\r
  opacity: 0;\r
  pointer-events: none;\r
  transition: opacity 0.15s ease;
}
.imgref-tile:hover .imgref-remove[data-v-452668e3],\r
.imgref-tile:focus-within .imgref-remove[data-v-452668e3] {\r
  opacity: 1;\r
  pointer-events: auto;
}
@media (hover: none), (pointer: coarse) {
...
.vp-text-scroll[data-v-527b7d7f] {\r
  scrollbar-width: thin;\r
  scrollbar-color: rgba(255, 255, 255, 0.35) transparent;
}
.vp-text-scroll[data-v-527b7d7f]::-webkit-scrollbar {\r
  width: 10px;
}
.vp-text-scroll[data-v-527b7d7f]::-webkit-scrollbar-track {\r
  background: transparent;
}
.vp-text-scroll[data-v-527b7d7f]::-webkit-scrollbar-thumb {\r
  background-color: rgba(255, 255, 255, 0.35);\r
  border-radius: 5px;\r
  border: 2px solid transparent;\r
  background-clip: content-box;
}
.vp-text-scroll[data-v-527b7d7f]:hover::-webkit-scrollbar-thumb {\r
  background-color: rgba(255, 255, 255, 0.55);
}
.ctv-batch-grid[data-v-527b7d7f] {\r
  display: grid;\r
...
.vp-img-actions[data-v-527b7d7f] {\r
  opacity: 0;\r
  pointer-events: none;\r
  transition: opacity 0.15s ease;
}
.vp-img-host:hover .vp-img-actions[data-v-527b7d7f],\r
.vp-img-host:focus-within .vp-img-actions[data-v-527b7d7f] {\r
  opacity: 1;\r
  pointer-events: auto;
}
@media (hover: none), (pointer: coarse) {
...
.ctv-crop-select[data-v-a2ee2b36] option {\r
  background: var(--interface-menu-surface, #1a1a1f);\r
  color: var(--base-foreground, #ddd);
}
.ctv-bound-input[data-v-a2ee2b36] { -moz-appearance: textfield;
}
.ctv-bound-input[data-v-a2ee2b36]::-webkit-inner-spin-button,\r
.ctv-bound-input[data-v-a2ee2b36]::-webkit-outer-spin-button {\r
...
.ctv-al-fill[data-v-59bf597a] .vp-img-host {\r
  flex: 1 1 0%;\r
  min-height: 0;
}
.ctv-al-fill[data-v-59bf597a] .vp-img-host > video {\r
  height: 100%;\r
  max-height: none;\r
  object-fit: contain;
}\r
...
import "./assets/main-Dm7gQXku.mjs";
