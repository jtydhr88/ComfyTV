...
export const CANVAS_PRESET_GROUPS: CanvasPresetGroup[] = [
  {
    id: 'paper',
    labelKey: 'pictor.presetGroupPaper',
    presets: [
  ...
  {
    id: 'business-card',
    labelKey: 'pictor.presetGroupBusinessCard',
    presets: [
  ...
  {
    id: 'web',
    labelKey: 'pictor.presetGroupWeb',
    presets: [
  ...
  {
    id: 'display',
    labelKey: 'pictor.presetGroupDisplay',
    presets: [
  ...
  {
    id: 'phone',
    labelKey: 'pictor.presetGroupPhone',
    presets: [
  ...
  {
    id: 'misc',
    labelKey: 'pictor.presetGroupMisc',
    presets: [
