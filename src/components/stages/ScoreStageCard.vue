<template>
  <div class="ctv:flex ctv:flex-col ctv:gap-1.5 ctv:size-full" @contextmenu.stop.prevent>
    ...
    <div
      class="ctv-scroll-thin ctv:relative ctv:flex-1 ctv:min-h-48 ctv:overflow-y-auto ctv:overflow-x-auto ctv:rounded ctv:border ctv:border-border-subtle ctv:bg-white"
      style="max-height: 520px; overscroll-behavior: contain;"
