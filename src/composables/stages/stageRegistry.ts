...
import PrevizStageCard from '@/components/stages/PrevizStageCard.vue'
...
export const RICH_STAGE_CARDS: Record<string, any> = {
  ...
  'ComfyTV.PrevizStage':              PrevizStageCard,
